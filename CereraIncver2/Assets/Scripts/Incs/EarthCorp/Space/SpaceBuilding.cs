...
public class SpaceBuilding : Building, IBuilding
{
    protected float energy, heavy, light, high;
    protected float energyCoef, heavyCoef, lightCoef, highCoef;
    ...
    protected override void CalculationConsumprtion()
    {
        ...
        highCoef = TakeGoods(Corp.MainClass.Earth.HighIndustry, high);
        SpentMoney += Corp.MainClass.Earth.Energy.Price * energy * energyCoef + Corp.MainClass.Earth.HeavyIndustry.Price * heavy * heavyCoef + Corp.MainClass.Earth.LightIndustry.Price * light * lightCoef + Corp.MainClass.Earth.HighIndustry.Price * high * highCoef;
        float totalCoef = energyCoef * heavyCoef * lightCoef * highCoef;
